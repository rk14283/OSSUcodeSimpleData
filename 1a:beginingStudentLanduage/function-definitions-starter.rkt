...
;In real world we would get rid of commented out stuff 
...
(above (bulb "red")
       (bulb "yellow")
       (bulb "green"))
; Using a function makes this code mode concise; if the function is named well, it gives more meaning as well 
